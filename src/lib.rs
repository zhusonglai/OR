...
#[derive(Debug)]
pub struct ORMAdapterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ORMAdapterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ORMAdapter processing");
    
    let mut processor = ORMAdapterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ORMAdapterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ORMAdapterProcessor::new(false);
